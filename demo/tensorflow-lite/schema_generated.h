...
inline const char *EnumNameBuiltinOperator(BuiltinOperator e) {
  if (flatbuffers::IsOutRange(e, BuiltinOperator_ADD, BuiltinOperator_SCATTER_ND)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char * const *EnumNamesBuiltinOptions() {
  static const char * const names[99] = {
    "NONE",
    "Conv2DOptions",
...
inline const char *EnumNameBuiltinOptions(BuiltinOptions e) {
  if (flatbuffers::IsOutRange(e, BuiltinOptions_NONE, BuiltinOptions_ScatterNdOptions)) return "";
  const size_t index = static_cast<size_t>(e);
